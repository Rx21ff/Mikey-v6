...
bot = telebot.TeleBot('7496558499:AAELKH3GHSDULFwdaMLRgdXq7Dti7ML22Vo')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @MikeyTDM")
